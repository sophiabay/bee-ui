...
import exampleRouter from './_router'
...
// export const asyncRouterMap = [].concat(...formatRoutes(store.getters.roles.length), exampleRouter)
// export const asyncRouterMap = exampleRouter
export function asyncRouterMap() {
  return [].concat(...formatRoutes(store.state.user.menu), exampleRouter)
}
